...
np.savez('obs64_gasscale.npz', t=times, I_clean=I_clean, I_noisy=I_noisy,
...
print("PASS" if (snr > 5 and 'obs64_gasscale.npz' in os.listdir('.')) else "FAIL")
