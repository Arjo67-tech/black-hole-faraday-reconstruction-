...
np.savez('observation48.npz', t=times, I_clean=I_clean, I_noisy=I_noisy,
...
print("PASS" if (snr > 5 and 'observation48.npz' in os.listdir('.')) else "FAIL")
