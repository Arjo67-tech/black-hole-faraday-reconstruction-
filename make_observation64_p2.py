...
S_TRUE, PHI0_TRUE, CHI0_TRUE = 1, 2.0, 0.3
NPHASE = 24
T_ORB = 2*np.pi/OMEGA
...
np.savez('observation64_p2.npz', t=times, I_clean=I_clean, I_noisy=I_noisy,
...
print("PASS" if (snr > 5 and 'observation64_p2.npz' in os.listdir('.')) else "FAIL")
